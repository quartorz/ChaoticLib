...
class UserDefinedObject: public ChaoticLib::Direct2D::UserDefinedObject<::UserDefinedObject<Window>, Window>{
	...
	typedef ChaoticLib::Direct2D::UserDefinedObject<::UserDefinedObject<Window>, Window> super;
